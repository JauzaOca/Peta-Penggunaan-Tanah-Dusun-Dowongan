...
map.getView().fit([12279870.267489, -870528.035656, 12283420.216659, -867967.950509], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Penggunaan Tanah Dusun Dowongan</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (56 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Nama	: Jauza Arian Nafis<br />NIT	: 2502010120<br />Kelas	: SPIP-D';
            }
